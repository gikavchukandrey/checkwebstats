...
<div class="bg-home  p-b-3 p-b-3 p-t-3 ">
	<div class="container-fluid ">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 p-b-3  m-b-3 text-xs-center ">
					<h1 class="p-t-3 p-b-1 "><strong><?php echo __("CheckWebStats"); ?></strong> <?php echo __("professional website statistics"); ?></h1>
					<strong class="p-t-3 home subtitle ">
						<?php echo __("Use our service to improve your site and identify stats about any website"); ?> 
					</strong>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-8  p-b-3 m-b-3 ">
					 <form class="form-inline form-url-home" onsubmit="return false">
	                   <div class="input-group input-group-lg ">
	                    <input class="form-control input-url" <?php if($scan_url){ ?> value="<?php echo $scan_url; ?>" <?php } ?> required type="text" placeholder="<?php echo __("Website URL to review"); ?>" />
	                        <button class="btn btn-blue hidden-md-down btn-start" type="submit"><?php echo __("Review"); ?></button>
	                ...
	                <div class="ads  p-t-3 m-t-3 ">
						<?php echo get_ads("ads1"); ?>					
					</div>
	...
	<div class="container-fluid ">
		...
		<div class="row features">
				<div class="col-lg-4    text-xs-center">
					...
					<p class="f">
						<?php echo __("Review any website including social stats and see similar sites."); ?> 
					</p>
				...
				<div class="col-lg-4  text-xs-center">
					...
					<h3><?php echo __("Optimization Checklist"); ?></h3>
					<p class="f">
						<?php echo __("See suggestions on what to improve on the website"); ?> 
					</p>
				...
				<div class="col-lg-4  text-xs-center">
					...
					<h3><?php echo __("SEO Analysis"); ?></h3>
					<p class="f">
						<?php echo __("SEO errors shown to improve rankings."); ?> 
					</p>
...
<!-- 		      <a href="<?php echo base_url(); ?><?php echo config_item("slug_login"); ?>"><?php echo __("Register Now for FREE!!"); ?> </a> -->
...
<?php if($bookmarks){ ?>
		<div class="container-fluid bg-gray p-b-2 ">
			<div class="container">
				<div class="row">
						<div class="col-md-12 ">
							<h2 class="nice-title "><i class="zmdi zmdi-bookmark"></i> <span><?php echo __("Your bookmarks "); ?></span>
							<a class="pull-xs-right" href="<?php echo base_url(); ?><?php echo config_item("slug_user"); ?>/bookmarks"> <?php echo __("View all"); ?> </a>          
							</h2>
						</div>
...
<div class="container-fluid bg-white  p-b-3 p-t-3 ">
	<div class="container">
	<div class="row">
			<div class="col-lg-12 p-b-3 p-t-3 m-t-3 m-b-3 text-xs-center">
				<?php
					$total2 = $totalSites + (time() / 3000);
				?>
				<h2><strong><?php echo number_format($total2); ?></strong> <?php echo __("sites has been analyzed by CheckWebsiteStats"); ?></h2>
				<strong class="home subtitle">
					<?php echo __("Many people trust CheckWebsiteStats to improve their website and to inform themselves about third party sites."); ?> 
				</strong>
...
<?php if($recents && 1 == 2){ ?>
		<div class="container-fluid bg-gray p-b-2 ">
			<div class="container">
				<div class="row">
						<div class="col-md-12 ">
							<h2 class="nice-title "><i class="zmdi zmdi-time-restore"></i> <span><?php echo __("Latest Updated Sites"); ?></span></h2>
						</div>
...
<div class="container-fluid bg-white p-t-3 p-b-3">
		<div class="container  m-t-3 ">
				<div class="row">
					...
					<div class="col-lg-4">
					  <div class="box box-primary">
					    <div class="box-header with-border">
					      <h3 class="box-title m-b-3"><?php echo __("Top Technologies"); ?></h3>
					    </div><!-- /.box-header -->
					    <!-- form start -->
					      ...
					      <table class="table table-hover">
					              ...
					              <tr>
					                ...
					                <td>
					                  <strong><a href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/<?php echo config_item("slug_made_with"); ?>/<?php echo urlencode($row->name); ?>"><?php echo ($row->name); ?></a></strong>
					...
					<?php if($technologiesw) { ?>
					<div class="col-lg-4">
					  <div class="box box-primary">
					    <div class="box-header with-border">
					     <h3 class="box-title m-b-3"><?php echo __("Top Web Servers"); ?></h3>
					    </div><!-- /.box-header -->
					    <!-- form start -->
					      ...
					      <table class="table table-hover">
					              ...
					              <?php
					                foreach ($technologiesw as $key => $row) 
					                {
					              ?>
					              <tr>
					                <td width="50px"><img style="height:30px;" src="<?php echo base_url(); ?>assets/images/icons/<?php echo $row->icon; ?>"></td>
					...
					<?php if($technologiesf) { ?>
					<div class="col-lg-4">
					  <div class="box box-primary">
					    <div class="box-header with-border">
					      <h3 class="box-title m-b-3"><?php echo __("Top Web Frameworks"); ?></h3>
					    </div><!-- /.box-header -->
					    <!-- form start -->
					      ...
					      <table class="table table-hover">
					              ...
					              <?php
					                foreach ($technologiesf as $key => $row) 
					                {
					              ?>
					              <tr>
					                <td width="50px"><img style="height:30px;" src="<?php echo base_url(); ?>assets/images/icons/<?php echo $row->icon; ?>"></td>
