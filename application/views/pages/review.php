<head>
    ...
    <?php if (config_item("chromeappid")) { ?>
        <link rel="chrome-webstore-item"
              href="https://chrome.google.com/webstore/detail/<?php echo config_item("chromeappid"); ?>">
    <?php } ?>
...
<?php if ($cached) {
    ...
    <div class="container">
        <div class="alert alert-warning m-t-2">
            <strong><i class="zmdi zmdi-alert-circle"></i> <?php echo __("Historical Data: "); ?>
            </strong> <?php echo __("This is a cache of"); ?> <?php echo $site->url; ?>
            <a class="pull-right " style="color:#FFF"
               href="<?php echo base_url(); ?><?php echo $site->url; ?>"><?php echo __("Go to last version"); ?></a>
...
?>
<div class="container <?php if ($cached) {
    echo 'historical';
} ?>" id="main">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4">
            <div class="card card-block score-fixed">
                ...
                <div class=" circle" data-color="<?php echo config_item("style_main_color"); ?>"
                     data-text="<?php echo __("Score Rank"); ?>"
                     data-fbw="<?php echo config_item("chart_border_size"); ?>"
                     data-bbw="<?php echo config_item("chart_border_size"); ?>" data-color="#4390BE"
                     data-percent="<?php echo $site->score; ?> "></div>
                ...
                if (intval($days) >= intval(config_item("update_inverval")) && !$cached) {
                    ?>
                    <button class="btn btn-secondary btn-sm btn-block btn-update "
                            data-domain="<?php echo $site->url; ?>"><i
                            class="zmdi zmdi-refresh-alt"></i> <?php echo __("Update"); ?></button><?php
                        ...
                        if ($value->id != $site->id) {
                            ...
                            <div class="site-list">
                                ...
                                <div class="data">
                                    ...
                                    <a href="<?php echo base_url(); ?><?php echo $value->url; ?>"
                                       class="subtitle truncate"><?php echo badWords($value->url); ?></a>
                                </div>
                            </div>
                        <?php }
                    } ?>
            ...
            <?php if (count($historicalData) >= 1) { ?>
                <div class="card card-block">
                    ...
                    <?php foreach ($historicalData as $key => $value) {
                        ...
                        ?>
                        <div class="site-list <?php if ($cached == date("Y-m-d", strtotime($value->created))) {
                            echo 'active';
                        } ?>">
                            <div class="score">
                            ...
                            <div class="data">
                                ...
                                <a href="<?php echo base_url(); ?><?php echo $old->url; ?>?d=<?php echo date("Y-m-d", strtotime($value->created)); ?>"
                                   class="subtitle truncate"><?php echo date("Y-m-d", strtotime($value->created)); ?></a>
                            </div>
                        </div>
                    <?php } ?>
                    <a class="d-block m-t-1 text-xs-center"
                       href="<?php echo base_url(); ?><?php echo config_item("slug_historical"); ?>/<?php echo $site->url; ?>"><?php echo __("View all historical data"); ?></a>
                </div>
            <?php } ?>
                    ...
                    <?php foreach ($top['technologies'] as $key => $value) {
                        ...
                        <div class="site-list">
                            ...
                            <div class="data">
                                ...
                                <a href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/<?php echo config_item("slug_made_with"); ?>/<?php echo urlencode($value->name); ?>"
                                   class="subtitle truncate"><?php echo($value->tag1); ?></a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
...
// Close request to clear up some resources
        ...
        <div class="col-lg-9 1 col-md-8">
            ...
            <div class="card card-block">
                <div class="col-lg-12">
                    <a class="small text-xs-center website" rel="nofollow external" target="_blank"
                       href="http://<?php echo $site->url; ?> ">
                        <i class="zmdi zmdi-shopping-cart"></i>
                    </a><b>Products</b> - check out these products from <b><a href='<?php echo badWords($site->url); ?>'
                                                                              onclick="window.open('<?php echo badWords($site->url); ?>');document.location.href='<?php echo badWords($site->url); ?>';"
                                                                              target="_blank"><?php echo badWords($site->url); ?> </a></b>
                </div>
                <div class="col-lg-12">
                    <div class='row'>
                        <?php
        ...
        <div class="col-lg-9 2 col-md-8">
            ...
            <div class="card card-block">
                <div class="col-lg-12">
                    ...
                    </a><b>Similar Websites</b> - check out these websites that are similar to <b><a
                                href='<?php echo badWords($site->url); ?>'
                                onclick="window.open('<?php echo badWords($site->url); ?>');document.location.href='<?php echo badWords($site->url); ?>';"
                                target="_blank"><?php echo badWords($site->url); ?> </a></b>
                </div>
                <div class="col-lg-12">
        ...
        <div class="col-lg-9 3 col-md-8">
                ...
                <div class="col-lg-8 p-t-1">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <small class="text-muted"><?php echo $stats["success"]; ?>
                                % <?php echo __("of passed verification steps"); ?></small>
                            <progress class="progress progress-success progress-sm"
                                      value="<?php echo $stats["success"]; ?>" max="100"></progress>
                        </div>


                        <div class="col-lg-12">
                            <strong class="text d-block"><?php echo __("Warning"); ?></strong>
                            <small class="text-muted"><?php echo $stats["warning"]; ?>
                                % <?php echo __("of total warning"); ?></small>
                            <progress class="progress progress-warning progress-sm"
                                      value="<?php echo $stats["warning"]; ?>" max="100"></progress>
                        </div>

                        <div class="col-lg-12">
                            <strong class="text d-block"><?php echo __("Errors"); ?></strong>
                            <small class="text-muted"><?php echo $stats["errors"]; ?>
                                % <?php echo __("of total errors, require fast action"); ?></small>
                            <progress class="progress progress-danger progress-sm"
                                      value="<?php echo $stats["errors"]; ?>" max="100"></progress>
                        </div>
                    </div>
                ...
                <div class="fot">
                        ...
                        if (is_logged()) {
                            if (isBookmark($site->id)) {
                                ?>
                                <div class="pull-right btn-bookmark  btn-link" data-action="1"
                                     data-idsite="<?php echo $site->id; ?>"><i
                                        class="zmdi zmdi-star"></i> <?php echo __("Remove from bookmark"); ?></div><?php
                            } else {
                                ?>
                                <div class="pull-right btn-bookmark  btn-link" data-action="2"
                                     data-idsite="<?php echo $site->id; ?>"><i
                                        class="zmdi zmdi-star-outline"></i> <?php echo __("Add to bookmark"); ?>
                                </div><?php
                            }
                        }
                        ?>

                        <div class="pull-right btn-link btn-toggle-class" data-class="animated bounceIn"
                             data-target="#share-block">
            ...
            <div class="p-b-1" id="share-block">
                ...
                <div class="btn-group d-block " role="group" aria-label="Share">
                    ...
                    ?>
                    <a href="#" data-url="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url_share; ?>"
                       class="btn btn-share btn-xs btn-facebook col-md-2 col-xs-12"><i
                                class="zmdi zmdi-facebook"></i></a>
                    <a href="#" data-url="https://twitter.com/home?status=<?php echo $url_share; ?>"
                       class="btn btn-share btn-xs btn-twitter col-md-2 col-xs-12"><i class="zmdi zmdi-twitter"></i></a>
                    <a href="#" data-url="https://plus.google.com/share?url=<?php echo $url_share; ?>"
                       class="btn btn-share btn-xs btn-google col-md-2 col-xs-12"><i class="zmdi zmdi-google-plus"></i></a>
                    <a href="#"
                       data-url="https://www.linkedin.com/shareArticle?mini=true&title=&summary=<?php echo $url_share; ?>&source=<?php echo $url_share; ?>&url=<?php echo $url_share; ?>"
                       class="btn btn-share btn-xs btn-linkedin col-md-2 col-xs-12"><i
                                class="zmdi zmdi-linkedin"></i></a>
                    <a href="#"
                       data-url="https://pinterest.com/pin/create/button/?media=<?php echo $url_share; ?>&description=<?php echo $this->metaTitle; ?>&url=<?php echo $url_share; ?>"
                       class="btn btn-share btn-xs btn-pinterest col-md-2 col-xs-12"><i class="zmdi zmdi-pinterest"></i></a>
                    <a href="#" data-url="mailto:?&body=<?php echo $url_share; ?>"
                       class="btn btn-share btn-xs btn-info col-md-2 col-xs-12"><i class="zmdi zmdi-email"></i></a>
                </div>
            ...
            <?php if (in_array("pagespeed", $modules)) { ?>
                <div class="card card-block hidden-md-down" id="pagespeed">
                    <?php if (in_array("pagespeed", $blocks)) { ?>
                        <div class="col-md-3">
                            <div class="circle" data-text="<?php echo __("PageSpeed Desktop"); ?>"
                                 data-fbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-bbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-color="<?php echo colorCircle($site->pageSpeed, 85); ?>"
                                 data-percent="<?php echo $site->pageSpeed; ?>"></div>
                        </div>

                        <div class="col-md-3">
                            <div class="circle" data-text="<?php echo __("PageSpeed Mobile"); ?>"
                                 data-fbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-bbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-color="<?php echo colorCircle($site->pagespeed_mobile, 85); ?>"
                                 data-percent="<?php echo $site->pagespeed_mobile; ?>"></div>
                        </div>

                        <div class="col-md-3">
                            <div class="circle" data-text="<?php echo __("Usability Mobile"); ?>"
                                 data-fbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-bbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-color="<?php echo colorCircle($site->pagespeed_usability, 85); ?>"
                                 data-percent="<?php echo $site->pagespeed_usability; ?>"></div>
                        </div>

                        <div class="col-md-3">
                            <div class="circle" data-text="<?php echo __("Domain Authority"); ?>"
                                 data-fbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-bbw="<?php echo config_item("chart_border_size"); ?>"
                                 data-color="<?php echo colorCircle($site->domainAuthority, 50); ?>"
                                 data-percent="<?php echo $site->domainAuthority; ?>"></div>
                        </div>
                    <?php } else {
                        show_register('pagespeed');
                    } ?>
                ...
                <div class="card card-block hidden-md-up" id="pagespeed">
                    <div class="row p-t-2 ">
                        <div class="col-lg-4">
                            <strong><i class="zmdi zmdi-circle <?php echo getColor($site->pageSpeed, 85); ?>   check"></i> <?php echo __("PageSpeed Desktop"); ?>
                            </strong>
                            <small class="text-muted d-block subtitle"><?php echo __("Score"); ?> <?php echo number_format($site->pageSpeed); ?>
                                %
                            </small>
                        </div>
                        <div class="col-lg-8">
                            <progress class="progress progress-sm <?php echo getColorProgress($site->pageSpeed, 85); ?>"
                                      value="<?php echo getPor($site->pageSpeed, 100); ?>" max="100"></progress>
                        </div>
                    </div>

                    <div class="row p-t-2 ">
                        <div class="col-lg-4">
                            <strong><i class="zmdi zmdi-circle <?php echo getColor($site->pagespeed_mobile, 85); ?>   check"></i> <?php echo __("pagespeed_mobile Mobile"); ?>
                            </strong>
                            <small class="text-muted d-block subtitle"><?php echo __("Score"); ?> <?php echo number_format($site->pagespeed_mobile); ?>
                                %
                            </small>
                        </div>
                        <div class="col-lg-8">
                            <progress
                                    class="progress progress-sm <?php echo getColorProgress($site->pagespeed_mobile, 85); ?>"
                                    value="<?php echo getPor($site->pagespeed_mobile, 100); ?>" max="100"></progress>
                        </div>
                    </div>

                    <div class="row p-t-2 ">
                        <div class="col-lg-4">
                            <strong><i class="zmdi zmdi-circle <?php echo getColor($site->domainAuthority, 50); ?>   check"></i> <?php echo __("Domain Authority"); ?>
                            </strong>
                            <small class="text-muted d-block subtitle"><?php echo __("Score"); ?> <?php echo number_format($site->domainAuthority); ?>
                                %
                            </small>
                        </div>
                        <div class="col-lg-8">
                            <progress
                                    class="progress progress-sm <?php echo getColorProgress($site->domainAuthority, 50); ?>"
                                    value="<?php echo getPor($site->domainAuthority, 100); ?>" max="100"></progress>
                        </div>
                    </div>

                    <div class="row p-t-2 ">
                        <div class="col-lg-4">
                            <strong><i class="zmdi zmdi-circle <?php echo getColor($site->pagespeed_usability, 85); ?>   check"></i> <?php echo __("Usability"); ?>
                            </strong>
                            <small class="text-muted d-block subtitle"><?php echo __("Score"); ?> <?php echo number_format($site->pagespeed_usability); ?>
                                %
                            </small>
                        </div>
                        <div class="col-lg-8">
                            <progress
                                    class="progress progress-sm <?php echo getColorProgress($site->pagespeed_usability, 85); ?>"
                                    value="<?php echo getPor($site->pagespeed_usability, 100); ?>" max="100"></progress>
                        </div>
                    </div>
                </div>
            ...
            <?php if (in_array("authority", $modules)) { ?>
                <div class="card card-block" id="authority">
                    ...
                    <?php if (in_array("authority", $blocks)) { ?>
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi zmdi-circle <?php echo getColor($site->pageAuthority, 24); ?>   check"></i> <?php echo __("Page Authority"); ?>
                                </strong>
                                <small class="text-muted d-block subtitle"><?php echo __("Authority"); ?> <?php echo number_format($site->pageAuthority); ?>
                                    %
                                </small>
                            </div>
                            <div class="col-lg-8">
                                <progress
                                        class="progress progress-sm <?php echo getColorProgress($site->pageAuthority, 24); ?>"
                                        value="<?php echo getPor($site->pageAuthority, 100); ?>" max="100"></progress>
                            </div>
                        </div>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi zmdi-circle <?php echo getColor($site->mozRank, 3); ?>   check"></i> <?php echo __("Moz Rank"); ?>
                                </strong>
                                <small class="text-muted d-block subtitle"><?php echo number_format($site->mozRank, 1); ?>
                                    /10
                                </small>
                            </div>
                            <div class="col-lg-8">
                                <progress
                                        class="progress progress-sm <?php echo getColorProgress($site->mozRank, 3); ?>"
                                        value="<?php echo getPor($site->mozRank, 10); ?>" max="100"></progress>
                            </div>
                        </div>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi zmdi-trending-up  <?php echo getColor(30, $site->bounceRate); ?> check"></i> <?php echo __("Bounce Rate"); ?>
                                </strong>
                                <small class="text-muted d-block subtitle"><?php echo __("Rate"); ?> <?php echo number_format($site->bounceRate); ?>
                                    %
                                </small>
                            </div>
                            <div class="col-lg-8">
                                <progress
                                        class="progress progress-sm <?php echo getColorProgress(30, $site->bounceRate); ?>"
                                        value="<?php echo getPor($site->bounceRate, 100); ?>" max="100"></progress>
                            </div>
                        </div>


                    <?php } else {
                        show_register('authority');
                    } ?>
                    ...
                    <?php if (in_array("meta", $blocks)) { ?>
                        <?php if ($site->charset) { ?>
                            <div class="row p-t-2 ">
                                <div class="col-lg-4">
                                    ...
                                    <strong><i class="zmdi zmdi-dot-circle  check"></i> <?php echo __("Charset"); ?>
                                    </strong>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                ...
                                ?>
                                <strong><i class="zmdi <?php echo $metaTitle['icon']; ?> <?php echo $metaTitle['color']; ?> check"></i> <?php echo __("Title Tag"); ?>
                                </strong>
                        ...
                        <div class="row  p-t-2">
                            <div class="col-lg-4">
                                ...
                                <strong><i class="zmdi <?php echo $metaDescription['icon']; ?> <?php echo $metaDescription['color']; ?> check"></i> <?php echo __("Meta Description"); ?>
                                </strong>
                        ...
                        <?php if ($site->url_real) { ?>
                            <div class="row p-t-2 ">
                                <div class="col-lg-4 ">
                                    ...
                                    ?>
                                    <strong><i class="zmdi zmdi-dot-circle  check"></i> <?php echo __("Effective URL"); ?>
                                    </strong>
                        ...
                        <?php if ($body_excerpt) { ?>
                            <div class="row  p-t-2">
                                <div class="col-lg-4">
                                    ...
                                    <strong><i class="zmdi  zmdi-dot-circle  check"></i> <?php echo __("Excerpt"); ?>
                                    </strong>
                        ...
                        <?php if ($site->metaKeywords != '') { ?>
                            <div class="row  p-t-2">
                                <div class="col-lg-4">
                                    ...
                                    ?>
                                    <strong><i class="zmdi zmdi-tag text-muted check"></i> <?php echo __("Meta Keywords"); ?>
                                    </strong>
                                ...
                                <div class="col-lg-8">
                                    <?php foreach ($keywords as $key => $value) {
                                        ...
                                        if (trim($value) != '') {
                                            ?>
                                            <a class="keyword"
                                               href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/tag/<?php echo urlencode($value); ?>"><?php echo $value; ?></a>
                                        <?php }
                                    } ?>
                        ...
                        if (count($keyw) > 0 && $keyw != '') { ?>
                            <div class="row  p-t-2 hidden-md-down">
                                <div class="col-lg-4">
                                    ...
                                    ?>
                                    <strong><i class="zmdi zmdi-tag text-muted check"></i> <?php echo __("Keywords Cloud"); ?>
                                    </strong>
                                ...
                                <div class="col-lg-8">
                                    <?php foreach ($keyw as $key => $value) {
                                        ...
                                        if (trim($key) != '') {
                                            ?>
                                            <span class="keyword-cloud"><?php echo more($key, 30); ?><span
                                                        class="value animated zoomIn"><?php echo $value; ?></span></span>
                                        <?php }
                                    } ?>
                            ...
                            <div class="row  p-t-2 hidden-md-down">
                                <div class="col-lg-4">
                                    ...
                                    ?>
                                    <strong><i class="zmdi zmdi-badge-check text-muted check"></i> <?php echo __("Keyword Consistency"); ?>
                                    </strong>
                                ...
                                <div class="col-lg-8">
                                    <table class="consistency table">
                                        ...
                                        foreach ($keyw as $key => $value) {
                                            ...
                                            <tr>
                                                <td>
                                                    <i class="zmdi zmdi-tag text-muted check"></i> <?php echo more(badWords($key), 20); ?>
                                                </td>
                        ...
                        <div class="row  p-t-2">
                            <div class="col-lg-4">
                                <strong><i class="zmdi zmdi-eye text-muted check"></i> <?php echo __("Google Preview"); ?>
                                </strong>
                        ...
                        <div class="row  p-t-2">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo getIcon($site->robots, 0); ?> <?php echo getColor($site->robots, 0); ?> check"></i> <?php echo __("Robots.txt"); ?>
                                </strong>
                        ...
                        <div class="row  p-t-2">
                            <div class="col-lg-4">
                                <strong><i class="zmdi  <?php echo getIcon($site->sitemap, 0); ?> <?php echo getColor($site->sitemap, 0); ?> check"></i> <?php echo __("Sitemap.xml"); ?>
                                </strong>
                        ...
                        if ($site->created_on && $site->created_on != '0000-00-00') {
                            ...
                            <div class="row  p-t-2">
                                <div class="col-lg-4">
                                    <strong><i class="zmdi  <?php echo getIcon($created_on, 360); ?> <?php echo getColor($created_on, 360); ?> check"></i> <?php echo __("Domain Age"); ?>
                                    </strong>
                                    <small class="text-muted d-block subtitle"><?php echo __("Domain creation info"); ?></small>
                                </div>
                                <div class="col-lg-8">
                                    <div class="text-muted text-small p-t-0">
                                        <div class="truncate"><i
                                                    class="zmdi <?php echo getIcon($created_on, 360); ?> <?php echo getColor($created_on, 360); ?>  check"></i> <?php echo __("Create on:"); ?> <?php echo($site->created_on); ?>
                                            / <?php echo ago($site->created_on); ?></div>
                                        <?php if ($site->expires_on && $site->expires_on != '0000-00-00') { ?>
                                            <div class="truncate"><i
                                                        class="zmdi <?php echo getIcon($expires_on, 90); ?> <?php echo getColor($expires_on, 90); ?> check"></i> <?php echo __("Expires on:"); ?> <?php echo($site->expires_on); ?>
                                                / <?php echo days2h($expires_on); ?></div>
                                        <?php } ?>
                        ...
                        <div class="row  p-t-2">
                            <div class="col-lg-4">
                                <strong><i class="zmdi  <?php echo getIcon($text_ratio, 20); ?> <?php echo getColor($text_ratio, 20); ?> check"></i> <?php echo __("Page Size"); ?>
                                </strong>
                                <small class="text-muted d-block subtitle"><?php echo __("Code & Text Ratio"); ?></small>
                                <small class="text-muted d-block subtitle">
                                    <progress
                                            class="progress <?php echo getColorProgress($text_ratio, 20); ?> 	progress-sm"
                                            value="<?php echo $text_ratio; ?>" max="100"></progress>
                                </small>
                            </div>
                            <div class="col-lg-8">
                                <div class="text-muted text-small p-t-0">
                                    <div class="truncate"><i
                                                class="zmdi <?php echo getIcon(2000000, $document_size); ?> <?php echo getColor(2000000, $document_size); ?>  check"></i> <?php echo __("Document Size:"); ?>
                                        ~<?php echo formatBytes($document_size); ?></div>
                                    <div class="truncate"><i
                                                class="zmdi <?php echo getIcon($code_size, 20); ?> <?php echo getColor($code_size, 20); ?>  check"></i> <?php echo __("Code Size:"); ?>
                                        ~<?php echo formatBytes($code_size); ?></div>
                                    <div class="truncate"><i
                                                class="zmdi <?php echo getIcon($text_ratio, 20); ?> <?php echo getColor($text_ratio, 20); ?>  check"></i> <?php echo __("Text Size:"); ?>
                                        ~<?php echo formatBytes($text_size); ?> <strong
                                                class=""><?php echo __("Ratio:"); ?> <?php echo number_format($text_ratio, 2); ?>
                                            %</strong></div>
            ...
            <?php if (in_array("social", $modules)) { ?>
                ...
                <h2 class="nice-title "><i class="zmdi zmdi-share"></i><span><?php echo __("Social Data"); ?></span>
                </h2>
                    ...
                    <?php if (in_array("social", $blocks)) {
                        ...
                        foreach ($social as $key => $value) {
                            ...
                            <div class="row p-t-2 " title="<?php echo number_format($porc, 2); ?>%">
                                <div class="col-lg-4">
                                    <strong><i class="fa fa-<?php echo $key; ?> <?php echo getColor($value, 1000); ?>   check"></i> <?php echo ucwords(__(str_ireplace("google-plus", "google plus", $key))); ?>
                                    </strong>
                                    <small class="text-muted d-block subtitle"><?php echo __("Total: "); ?><?php echo number_format($value); ?></small>
                                </div>
                                <div class="col-lg-8">
                                    <progress class="progress progress-sm <?php echo getColorProgress($value, 1000); ?>"
                                              value="<?php echo $porc; ?>" max="100"></progress>
                                </div>
                            </div>
                            <?php
                        }
            ...
            <?php if (in_array("traffic", $modules)) { ?>
                ...
                <h2 class="nice-title "><i
                            class="zmdi zmdi-traffic"></i><span><?php echo __("Estimation Traffic and Earnings"); ?></span>
                </h2>
                    ...
                    <?php if (in_array("traffic", $blocks)) { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="box-info green">
                                    <div class="value">
                                        $<?php echo number_format(($site->IncomeDaily * 22) * 12); ?></div>
                                    <div class="title"><?php echo __("Income"); ?></div>
                                    <div class="subtitle"><?php echo __("Yearly"); ?></div>
                                </div>
                            </div>
            ...
            <?php if (count($technologies) > 0 && in_array("technologies", $modules)) { ?>
                ...
                <h2 class="nice-title "><i
                            class="zmdi zmdi-code-setting"></i><span><?php echo __("Technologies"); ?></span></h2>
                    ...
                    <?php if (in_array("technologies", $blocks)) { ?>
                        <?php foreach ($technologies as $key => $value) {
                            ...
                            <div class="col-md-6 p-b-2 p-t-1" id="technologies">
                                <a class="media text-muted"
                                   href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/<?php echo config_item("slug_made_with"); ?>/<?php echo urlencode($value->name); ?>">
					  <span class="media-left">
					    <img class="media-object tec-img"
                             src="<?php echo base_url(); ?>assets/images/icons/<?php echo $value->icon; ?>"
            ...
            <?php if (in_array("pagespeed_stats", $modules) && $site->pagespeed_rules) { ?>
                ...
                <h2 class="nice-title "><i
                            class="zmdi zmdi-google"></i><span><?php echo __("Google PageSpeed Insights"); ?></span>
                </h2>
                ...
                <?php if (in_array("pagespeed_stats", $blocks)) { ?>
                    ...
                    <div class="row  p-t-2">
                        ...
                        <div class="col-lg-8">
                            <div class=" p-t-0">
                                ...
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Number Resources:"); ?>
                                <span class="text-muted"><?php echo number_format($site->pagespeed_numberResources); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Number Hosts:"); ?> <span
                                        class="text-muted"><?php echo number_format($site->pagespeed_numberHosts); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Total Request:"); ?> <span
                                        class="text-muted"><?php echo formatBytes($site->pagespeed_totalRequestBytes); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Number Static Resources:"); ?>
                                <span class="text-muted"><?php echo number_format($site->pagespeed_numberStaticResources); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("HTML Response:"); ?> <span
                                        class="text-muted"><?php echo formatBytes($site->pagespeed_htmlResponseBytes); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("CSS Response:"); ?> <span
                                        class="text-muted"><?php echo formatBytes($site->pagespeed_cssResponseBytes); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Image Response:"); ?> <span
                                        class="text-muted"><?php echo formatBytes($site->pagespeed_imageResponseBytes); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Javascript Response:"); ?>
                                <span class="text-muted"><?php echo formatBytes($site->pagespeed_javascriptResponseBytes); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Other Response:"); ?> <span
                                        class="text-muted"><?php echo formatBytes($site->pagespeed_otherResponseBytes); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Number JS Resources:"); ?>
                                <span class="text-muted"><?php echo number_format($site->pagespeed_numberJsResources); ?></span><br>
                                <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Number CSS Resources:"); ?>
                                <span class="text-muted"><?php echo number_format($site->pagespeed_numberCssResources); ?></span><br>
                    ...
                    <h2 class="nice-title "><i
                                class="zmdi zmdi-desktop-mac"></i><span><?php echo __("Desktop"); ?></span></h2>

                    <div class="card card-block ">
                        <?php if ($site->pagespeed_screenshot_d) { ?>
                            <img class="text-xs-center hidden-sm-down card screenshot-desktop"
                                 alt="<?php echo __("Desktop Screenshot"); ?>"
                                 src="<?php echo renderScreenshot($site); ?>">
                        <?php } ?>
                        ...
                        foreach ($google_rules->ruleResults as $key => $value) {
                            ...
                            <div class="row p-t-2 ">
                                <div class="col-lg-6 truncate">
                                    <strong class="truncate"><i
                                                class="zmdi zmdi-<?php echo $icon[$impact];; ?> text-<?php echo $color[$impact]; ?> check"></i> <?php echo __($value->localizedRuleName); ?>
                                    </strong>
                    ...
                    <h2 class="nice-title "><i
                                class="zmdi zmdi-smartphone-android"></i><span><?php echo __("Mobile"); ?></span></h2>
                    <div class="card card-block ">
                    <?php if ($site->pagespeed_screenshot_m) { ?>
                        <img alt="<?php echo __("Mobile Screenshot"); ?>"
                             class="text-xs-center hidden-sm-down card screenshot-mobile"
                             src="<?php echo renderScreenshot($site, true); ?>">
                    <?php } ?>
                    <?php
            ...
            <?php if (in_array("tips", $modules)) { ?>
                ...
                <h2 class="nice-title "><i
                            class="zmdi zmdi-help"></i><span><?php echo __("Speed And Optimization Tips"); ?></span>
                </h2>
                <div class="card card-block" id="tips">
                    <?php if (in_array("tips", $blocks)) { ?>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['title']); ?> text-<?php echo $optimize['title']; ?> check"></i> <?php echo __("Title Website"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['description']); ?> text-<?php echo $optimize['description']; ?> check"></i> <?php echo __("Description Website"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle text-muted"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['robots']); ?> text-<?php echo $optimize['robots']; ?> check"></i> <?php echo __("Robots.txt"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['sitemap']); ?> text-<?php echo $optimize['sitemap']; ?> check"></i> <?php echo __("sitemap.xml"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
					...
					<div class="col-lg-8">
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['https']); ?> text-<?php echo $optimize['https']; ?> check"></i> <?php echo __("SSL Secure"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle text-muted"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['pageSpeed']); ?> text-<?php echo $optimize['pageSpeed']; ?> check"></i> <?php echo __("Pagespeed"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['pagespeed_mobile']); ?> text-<?php echo $optimize['pagespeed_mobile']; ?> check"></i> <?php echo __("Pagespeed Mobile"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['headers']); ?> text-<?php echo $optimize['headers']; ?> check"></i> <?php echo __("Headings"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['google_safe']); ?> text-<?php echo $optimize['google_safe']; ?> check"></i> <?php echo __("Blacklist"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['w3c']); ?> text-<?php echo $optimize['w3c']; ?> check"></i> <?php echo __("W3C Validator"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['hasAMP']); ?> text-<?php echo $optimize['hasAMP']; ?> check"></i> <?php echo __("Accelerated Mobile Pages (AMP)"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['domainAuthority']); ?> text-<?php echo $optimize['domainAuthority']; ?> check"></i> <?php echo __("Domain Authority"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['gzip']); ?> text-<?php echo $optimize['gzip']; ?> check"></i> <?php echo __("GZIP Compress"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['favicon']); ?> text-<?php echo $optimize['favicon']; ?> check"></i> <?php echo __("Favicon"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle text-muted"></i>
                                    <i class="zmdi zmdi-dot-circle text-muted"></i>
                        ...
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi <?php echo converTypeToIcon($optimize['links']); ?> text-<?php echo $optimize['links']; ?> check"></i> <?php echo __("Broken Links"); ?>
                                </strong>
                                <small class="d-block subtitle">
                                    <i class="zmdi zmdi-dot-circle"></i>
                                    <i class="zmdi zmdi-dot-circle"></i>
                            ...
                            <div class="col-lg-8">
                                ...
                                <span class="cursor-pointer btn-link btn-toggle-class" data-target=".list-links"
                                      data-class="show"><?php echo __("View links"); ?></span>
                            ...
                            <div class="col-lg-12  list-links">
                                ...
                                <div class="text-muted text-small p-t-1">
                                    <table class=" table" width="100%">
                                        <tr class="header">
                                            <td class="">
                                                <strong><?php echo str_ireplace("%count%", count($links), __("First %count% Links")); ?> </strong>
                                            </td>
                                            <td class="text-xs-center">
                                                <strong><?php echo __("Relationship"); ?> </strong></td>
                                            <td class="text-xs-center"><strong><?php echo __("HTTP Status"); ?></strong>
                                            </td>
                                        </tr>
                                                ...
                                                <tr>
                                                    <td class="truncate" style="max-width: 300px">
                                                        <a rel="nofollow external" target="_blank"
                                                           href="<?php echo $value->link; ?>"><i
                                                                    class="zmdi zmdi-link check"></i>
                        ...
                        <div class="row p-t-2 ">
                            ...
                            <?php if ($country[1]) { ?>
                                <div class="col-lg-12 text-xs-center p-t-2 ">
                                    <div id="map" class="map" data-country="<?php echo $country[1]; ?>"
                        ...
                        <?php if (!$cached) { ?>
                            <div class="row p-t-2 ">
                                <div class="col-lg-6 img-alexa">
                                    ...
                                    <img class="img-fluid"
                                         src="https://traffic.alexa.com/graph?o=lt&y=t&b=ffffff&n=666666&f=999999&r=1y&t=2&z=30&c=1&h=300&w=500&u=<?php echo $site->url; ?>">
                                </div>
                                <div class="col-lg-6 img-alexa">
                                    <strong><?php echo __("Search"); ?></strong>
                                    <img class="img-fluid"
                                         src="https://traffic.alexa.com/graph?o=lt&y=q&b=ffffff&n=666666&f=999999&r=1y&t=2&z=30&c=1&h=300&w=500&u=<?php echo $site->url; ?>">
                                </div>
            ...
            <?php if (in_array("domain_available", $modules) && !$cached) { ?>
                ...
                <h2 class="nice-title "><i class="zmdi zmdi-link"></i><span><?php echo __("Domain Available"); ?></span>
                </h2>
                            ...
                            <?php foreach ($domains as $key => $value) {
                                if ($value->domain) {
                                    ...
                                    <tr>
                                        ...
                                        <td <?php if ($value->registered != '1') {
                                            echo 'class="text-success"';
                                        } else {
                                            echo 'class="text-danger"';
                                        } ?>><?php echo $available; ?></td>
                                    </tr>
                                    <?php
                                }
                            }
            ...
            <?php if (in_array("server", $modules)) { ?>
                ...
                <h2 class="nice-title "><i
                            class="zmdi zmdi-device-hub"></i><span><?php echo __("Information Server"); ?></span></h2>
                <div class="card card-block" id="server">
                    <?php if (in_array("server", $blocks)) { ?>
                        <div class="row p-t-2 ">
                            <div class="col-lg-4">
                                <strong><i class="zmdi zmdi-code check"></i> <?php echo __("Response Header"); ?>
                                </strong>
                                <small class="text-muted d-block subtitle">
                        ...
                        if ($ips[0] && $ips[0] != '127.0.0.1') {
                            ...
                            <div class="row p-t-2 ">
                                <div class="col-lg-4">
                                    <strong><i class="zmdi zmdi-globe check"></i> <?php echo __("IP Server"); ?>
                                    </strong>
                                    <small class="text-muted d-block subtitle">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    foreach ($ips as $key => $value) {
                                        if ($value != '') {
                                            ?><i class="zmdi zmdi-laptop-chromebook check"></i> <a class="text-muted"
                                                                                                   href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/ip/<?php echo urlencode($value); ?>"><?php echo $value; ?></a>
                                            <br><?php
                                        }
                                    }
                            ...
                            <?php if ($site->city) { ?>
                                <div class="row p-t-2 ">
                                    <div class="col-lg-4">
                                        <strong><i class="zmdi zmdi-info check"></i> <?php echo __("IP Details"); ?>
                                        </strong>
                                        <small class="text-muted d-block subtitle">
                                    ...
                                    <div class="col-lg-8">
                                        <i class="zmdi zmdi-info-outline check"></i> <?php echo __("City:"); ?> <a
                                                class="text-muted"
                                                href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/city/<?php echo urlencode($site->city); ?>"><?php echo $site->city; ?></a><br>
                                        <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Country:"); ?> <a
                                                class="text-muted"
                                                href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/country/<?php echo urlencode($site->country); ?>"><?php echo $site->country; ?></a><br>
                                        <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Region:"); ?> <a
                                                class="text-muted"
                                                href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/region/<?php echo urlencode($site->region); ?>"><?php echo $site->region; ?></a><br>
                                        <i class="zmdi zmdi-info-outline check"></i> <?php echo __("ISP:"); ?> <a
                                                class="text-muted"
                                                href="<?php echo base_url(); ?><?php echo config_item("slug_filter"); ?>/isp/<?php echo urlencode($site->isp); ?>"><?php echo $site->isp; ?></a><br>
                        ...
                        if (count($result) > 1) {
                            ...
                            <div class="row  p-t-2 hidden-md-down">
                                <div class="col-lg-4">
                                    <strong><i class="zmdi zmdi-info check"></i> <?php echo __("DNS Records"); ?>
                                    </strong>
                                    <small class="text-muted d-block subtitle">
                                ...
                                <div class="col-md-8 m-t-2">
                                    <span class="cursor-pointer btn-link btn-toggle-class " data-class="show"
                                          data-target=".list-links"><?php echo __("View DNS Records"); ?></span>
                                </div>
                        ...
                        if ($curl_info) {
                            ...
                            <div class="row p-t-2 ">
                                <div class="col-lg-4">
                                    <strong><i class="zmdi zmdi-developer-board check"></i> <?php echo __("Response Server"); ?>
                                    </strong>
                                    <small class="text-muted d-block subtitle"><?php echo __("Information regarding a specific transfer"); ?></small>
                                </div>

                                <div class="col-lg-8">
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("URL:"); ?> <span
                                            class="text-muted"><?php echo $curl_info->url; ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Content Type:"); ?>
                                    <span class="text-muted"
                                          title="<?php echo __("Content-Type: of the requested document. NULL indicates server did not send valid Content-Type: header"); ?>"><?php echo $curl_info->content_type; ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Http Code:"); ?> <span
                                            class="text-muted"
                                            title="<?php echo __("The last response code"); ?>"><?php echo $curl_info->http_code; ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Header Size:"); ?> <span
                                            class="text-muted"
                                            title="<?php echo __("Total size of all headers received"); ?>"><?php echo formatBytes($curl_info->header_size); ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Request Size:"); ?>
                                    <span class="text-muted"
                                          title="<?php echo __("Total size of issued requests, currently only for HTTP requests"); ?>"><?php echo formatBytes($curl_info->request_size); ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Total Time:"); ?> <span
                                            class="text-muted"
                                            title="<?php echo __("Total transaction time in seconds for last transfer"); ?>"><?php echo($curl_info->total_time); ?><?php echo __("Seconds"); ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Name Lookup Time:"); ?>
                                    <span class="text-muted"
                                          title="<?php echo __("Time in seconds until name resolving was complete"); ?>"><?php echo($curl_info->namelookup_time); ?><?php echo __("Seconds"); ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Pretransfer Time:"); ?>
                                    <span class="text-muted"
                                          title="<?php echo __("Time in seconds from start until just before file transfer begins"); ?>"><?php echo($curl_info->pretransfer_time); ?><?php echo __("Seconds"); ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Download Size:"); ?>
                                    <span class="text-muted"
                                          title="<?php echo __("Total number of bytes downloaded"); ?>"><?php echo formatBytes($curl_info->size_download); ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Speed Download:"); ?>
                                    <span class="text-muted"
                                          title="<?php echo __("Average download speed"); ?>"><?php echo formatBytes($curl_info->speed_download); ?><?php echo __("Per seconds"); ?></span><br>
                                    <i class="zmdi zmdi-info-outline check"></i> <?php echo __("Start Rransfer Time:"); ?>
                                    <span class="text-muted"
                                          title="<?php echo __("Time in seconds until the first byte is about to be transferred"); ?>"><?php echo($curl_info->starttransfer_time); ?><?php echo __("Seconds"); ?></span><br>
            ...
            <?php if (config_item("disqus_shortname") && !$cached) { ?>
                ...
                <h2 class="nice-title "><i
                            class="zmdi zmdi-comment-alt-text"></i><span><?php echo __("Comments"); ?></span></h2>
                <div class="card card-block">
...
-->
       ...
       <div class="col-md-12 text-xs-right">
         <strong><?php echo __("Languages"); ?></strong> |
            ...
            ?>
                            <a <?php if (get_cookie("lang") == $value["code"]) {
                echo 'class="active"';
            } ?> href="?lang=<?php echo $value["code"]; ?>"><i class="zmdi zmdi-translate"></i> <?php echo $value["name"]; ?></a>
                            <?php
        }
        ?>
    </div>
...
-->
    ...
    <div class="shortcut">
        <ul class=" ">
            ...
            <?php if (!is_logged()) {
                ?>/*
                <li class="register-login"><a class=""
                                              href="<?php echo base_url(); ?><?php echo config_item("slug_login"); ?>"><?php echo __("Login/Register"); ?></a>
                </li> */<?php
            } else {
                ?>
                ...
                <li class="profile">
                    <div>
                        ...
                        <a class="setting" title="<?php echo __("My Profile"); ?>"
                           href="<?php echo base_url(); ?><?php echo config_item("slug_user"); ?>"><i
                                    class="zmdi zmdi-settings"></i></a>
                        <a class="logout" title="<?php echo __("Logout"); ?>"
                           href="<?php echo base_url(); ?><?php echo config_item("slug_logout"); ?>"><i
                                    class="zmdi zmdi-power"></i> </a>
                        <a title="<?php echo __("Bookmarks"); ?>" class="bookmarks"
                           href="<?php echo base_url(); ?><?php echo config_item("slug_user"); ?>/bookmarks"><i
                                    class="zmdi zmdi-bookmark"></i>
                    ...
                    <?php if (is_sadmin()) { ?>
                        <a class="administrator" href="<?php echo base_url(); ?>admin/dashboard"><i
                                    class="zmdi zmdi-settings-square"></i> <?php echo __("Go to Administrator"); ?></a>
                    <?php } ?>

                    <?php if (isAvailablePlan()) { ?>
                        <a class="upgradePlan"
                           href="<?php echo base_url(); ?><?php echo config_item("slug_subscriptions"); ?>"><i
                                    class="zmdi zmdi-mood"></i> <?php echo __("Upgrade Plan"); ?></a>
                    <?php } ?>
                </li>
            ...
            <?php if ($shortcut) { ?>
                <li class="hide shortcut-links">
                    ...
                    foreach ($modules as $key => $value) {
                        ?>
                        <a class="truncate" href="#" data-go="#<?php echo $value; ?>"><i
                                    class="zmdi zmdi-chevron-right"></i> <?php echo __("Shortcut " . $value); ?></a>
            ...
            <?php if (config_item("page_contact_form") == '1') {
                ...
                <?php foreach ($pages as $key => $value) {
                    ?>
                    <a class="truncate"
                       href="<?php echo base_url(); ?><?php echo config_item("slug_pages"); ?>/<?php echo $value->slug; ?>"><i
                                class="zmdi zmdi-google-pages"></i> <?php echo $value->title; ?></a>
                    <?php
                }
                ?>

                <?php if (config_item("page_contact_form") == '1') {
                    ?><a href="<?php echo base_url(); ?><?php echo config_item("slug_contact"); ?>"><i
                            class="zmdi zmdi-email"></i> <?php echo __("Contact"); ?></a><?php
                }
                ?>
                <?php if (config_item("page_last_sites") == '1') {
                    ?><a href="<?php echo base_url(); ?><?php echo config_item("slug_last"); ?>"><i
                            class="zmdi zmdi-calendar-check"></i> <?php echo __("Latest Updated Sites"); ?></a><?php
                }
                ?>
                <?php if (config_item("page_top_sites") == '1') {
                    ?><a href="<?php echo base_url(); ?><?php echo config_item("slug_top"); ?>"><i
                            class="zmdi zmdi-folder-star-alt"></i> <?php echo __("Top Sites"); ?></a><?php
                }
                ?>
            ...
            <?php if (count($bookmarks) > 0) { ?>
                ...
                <li class="hide truncate">
                    ...
                    <?php foreach ($bookmarks as $key => $value) {
                        if ($key <= 5) {
                            ?>
                            <a class="truncate" href="<?php echo base_url(); ?><?php echo $value->url; ?>"><i
                                        class="zmdi zmdi-globe"></i> <?php echo $value->url_real; ?></a>
                            <?php
                        }
                    }
                    ?>
                    <a class="truncate"
                       href="<?php echo base_url(); ?><?php echo config_item("slug_user"); ?>/bookmarks"><i
                                class="zmdi zmdi-bookmark"></i> <?php echo __("View all bookmarks"); ?></a>
            ...
            <li class="hide">
                ...
                <?php foreach (config_item("langs") as $key => $value) {
                    ...
                    <a <?php if (get_cookie("lang") == $value["code"]) {
                        echo 'class="active"';
                    } ?> href="?lang=<?php echo $value["code"]; ?>"><i
                                class="zmdi zmdi-translate"></i> <?php echo $value["name"]; ?></a>
                    <?php
                }
                ?>
